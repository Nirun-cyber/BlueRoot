...
const Navbar: React.FC = () => {
  ...
  return (
    <header className="h-20 bg-white dark:bg-[#0a0a0a] border-b border-black/5 dark:border-white/10 px-8 flex items-center justify-between sticky top-0 z-50 transition-colors duration-300">
      <div className="flex-1 max-w-xl">
        <div className="flex items-center gap-3 bg-slate-50 dark:bg-white/5 px-4 py-2.5 rounded-xl border border-slate-100 dark:border-white/5 focus-within:border-agri-green/50 transition-colors">
